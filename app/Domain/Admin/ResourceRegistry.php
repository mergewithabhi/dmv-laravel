        ...
        return [
            'people' => [
                ...
                'fields' => [
                    ...
                    'social_links' => $this->field('Social links JSON', 'json', 'nullable|json', full: true),
                    'statistics' => $this->field('Statistics JSON', 'json', 'nullable|json', full: true),
            ...
            'venues' => [
                ...
                'fields' => [
                    ...
                    'amenities' => $this->field('Amenities JSON', 'json', 'nullable|json', full: true),
            ...
            'sponsor-tiers' => [
                ...
                'fields' => [
                    ...
                    'benefits' => $this->field('Benefits JSON', 'json', 'nullable|json', full: true),
